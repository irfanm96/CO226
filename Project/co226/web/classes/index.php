    ...
    <div class="w3-row">
        ...
        <div class="w3-col s12 m8 l8">
            ...
            <ul class="w3-navbar w3-theme-l2" style="margin: 10px 16px;">
                ...
                <li><a href="add.php" class="tablink">New Class </a></li>
            ...
            <div class="w3-container">
                <div class="w3-responsive">
                    <table class="w3-table w3-bordered w3-striped w3-border w3-hoverable">
                        ...
                        <?php
                        $details = $db->listClasses();
                        foreach ($details as $detail) {
                            print "<tr>
                        <td>".$db->getCourse($detail['courseId'])['courseTitle']."</td>
                        <td>".$detail['classType']."</td>
                        <td>".$detail['classDate']."</td>
                        <td>".$detail['classTime']."</td>
                        <td>".$detail['duration']."</td>
                        <td>".$db->getUserName($detail['conductedBy'])."</td>
                        <td>"."
                        <a href=edit.php?id=".$detail['id'].">Edit</a> | <a href=delete.php?id=".$detail['id'].">Delete</a></td></tr>";
                        }
                        ?>
                    </table>
